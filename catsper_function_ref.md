...
- [Gaussian](https://uk.mathworks.com/help/signal/ref/gausswin.html): Gaussian function. As the Gaussian function spans $\[-\inf,\inf\]$, the Gaussian window does not end at zero at the edges. It is a general-purpose window used for smoothing signals whilst preserving key spectral features.
