...
- [Chebyshev](https://uk.mathworks.com/help/signal/ref/chebwin.html): Product of the Chebyshev polynomial and a cosine term, which is used to control oscillations in frequency response. It enables customisation where the level of side lobe attenuation can be manually adjusted to minimise spectral leakage.
